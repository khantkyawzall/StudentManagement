...
<body>
	...
	<div class="container">
		<div class="sidenav">
         ...
         <a href="/StudentReg/useruser/courseregisterForUser">Course Registration </a> <a
					href="/StudentReg/studentstudent/studentregisterForUser">Student Registration
				</a> <a href="/StudentReg/studentstudent/studentsearchForUser">Student Search </a>
        </div>
        
      </div>
		<div class="main_contents">
			<div id="sub_content">
				<form:form action="studentregisterForUser" method="post" modelAttribute="student" enctype="multipart/form-data">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<form:input type="text" class="form-control" path="phone" id="phone"></form:input>
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-md-2"></div>
					...
					<div class="row mb-4">
						<div class="col-md-2"></div>
						<label for="education" class="col-md-2 col-form-label">Attend</label>
						<div class="col-md-4">
							<form:select multiple="multiple" path="courses"
								class="form-select" aria-label="Education" id="education">
	...
	function validatePhoneNumber() {
		...
		var phonePattern = /^\d{11}$/; // Matches a 11-digit number
