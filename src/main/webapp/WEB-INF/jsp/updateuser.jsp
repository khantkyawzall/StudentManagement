	...
	<div class="container">
		...
		<div class="main_contents">
			<div id="sub_content">
				...
				<form:form action="/StudentReg/user/updateuser" method="post"
					modelAttribute="user">

					<h2 class="col-md-6 offset-md-2 mb-5 mt-4">User Update</h2>
					<h6 class="error">${error}</h6>
					<h6 class="errors">${error1}</h6>
					<div class="row mb-4">
						<div class="col-md-2"></div>
						<div class="col-md-4">
							<form:input type="hidden" class="form-control" path="id"
								value="${userup.id}"></form:input>
						</div>
					</div>
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<form:input type="password" class="form-control" path="password"
								value="${userup.password}"></form:input>
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-md-2"></div>
						...
						<div class="col-md-4">
							<form:input type="password" class="form-control"
								path="confirmpassword" value="${userup.confirmpassword}"></form:input>
						</div>
					</div>
					<%-- <div class="row mb-4">
						<div class="col-md-2"></div>
						<label for="userrole" class="col-md-2 col-form-label">User
							Role</label>
						<div class="col-md-4">
							<form:input type="text" class="form-control" path="userrole"
								value="${userup.userrole}" readonly="readonly"  />
						</div>
					</div> --%>
